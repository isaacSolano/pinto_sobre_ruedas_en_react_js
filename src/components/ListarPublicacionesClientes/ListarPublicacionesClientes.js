...
const ListarPublicacionesClientes = () => {
    ...
    useEffect( () => {
        let obtenerPublicacionesAdmin = async() => {
            let publicacionesAdmin = await ServicioPublicaciones.obtenerPublicacionesRol([1]);
    ...
    return(
        <>
            ...
            <main className="container">
                ...
                <div className="row">
                    <h2 className="col-md-12 text-center text-brown p-5">Publicaciones de otros usuarios</h2>
                </div>
...
export default ListarPublicacionesClientes